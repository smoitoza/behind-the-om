...
const SAMPLE_REVIEWS = [
  ...
  { studioId: "goleta", teacher: "Sabrina Z.", classType: "ys", rating: 2, teacherRating: 2, cleanRating: 3, vibeRating: 2, diffRating: 3, heatRating: 4, text: "Pretty disappointed with my Sculpt experience. The instructor seemed to be going through the motions and barely gave any cues for transitions. I was lost half the time. Also the studio smelled like it hadn't been cleaned between classes. For what you pay at CorePower I expected way more.", name: "Vanessa T.", date: "2026-01-03" },
  { studioId: "goleta", teacher: "General Studio Review", classType: "c2", rating: 2, teacherRating: 3, cleanRating: 2, vibeRating: 3, diffRating: 4, heatRating: 5, text: "The heat in the C2 room was absolutely unbearable — felt way hotter than any other CorePower I've been to. I had to step out twice just to breathe. The front desk didn't seem to care when I mentioned it. Mats for rent were worn out and slippery. Won't be back unless they fix the ventilation.", name: "Derek J.", date: "2025-12-18" },
  ...
  { studioId: "la-cumbre", teacher: "Jen M.", classType: "c2", rating: 2, teacherRating: 2, cleanRating: 3, vibeRating: 2, diffRating: 3, heatRating: 4, text: "Honestly not a great experience. The teacher talked way too much during the flow — felt more like a lecture than a yoga class. Couldn't get into any kind of rhythm. The plaza parking situation is also really annoying, especially on weekends. I'll stick to State Street.", name: "Katie R.", date: "2026-01-15" },
  { studioId: "la-cumbre", teacher: "General Studio Review", classType: "hpf", rating: 3, teacherRating: 3, cleanRating: 2, vibeRating: 3, diffRating: 3, heatRating: 5, text: "Went for the HPF class and it was fine but the locker room situation really turned me off. Showers were dirty, there was hair everywhere, and someone's stuff was just left on the bench for the entire class. The yoga itself was decent but the facilities need attention. For the monthly price they charge, this isn't acceptable.", name: "Greg W.", date: "2025-12-28" },
  ...
  { studioId: "state-street", teacher: "Dani N.", classType: "ys", rating: 2, teacherRating: 2, cleanRating: 3, vibeRating: 2, diffRating: 4, heatRating: 4, text: "Yoga Sculpt was way too intense for what was described as an 'all levels' class. The instructor moved so fast I couldn't keep up with the weight transitions and almost dropped a dumbbell on my foot. No modifications were offered. Felt like the class was designed to make beginners feel bad. Not welcoming at all.", name: "Amy L.", date: "2025-12-22" },
  { studioId: "state-street", teacher: "Riley M.", classType: "c2", rating: 3, teacherRating: 3, cleanRating: 2, vibeRating: 3, diffRating: 3, heatRating: 4, text: "The C2 class was okay but nothing special. My main issue is how packed the classes are — my mat was literally touching both neighbors. In a heated room that's really uncomfortable. Also the studio could use a deep clean, especially the corners of the yoga room. For downtown SB prices I expected a more premium experience.", name: "Marcus T.", date: "2026-01-18" },

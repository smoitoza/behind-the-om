...
const SAMPLE_REVIEWS = [
  // Goleta
  { studioId: "goleta", teacher: "Steven P.", classType: "c2", rating: 5, teacherRating: 5, cleanRating: 4, vibeRating: 5, diffRating: 5, heatRating: 4, text: "Literally obsessed with Steven's C2 class. My roommate dragged me here last quarter and now I go like 4x a week lol. The heat is no joke but you get used to it. Best stress relief during finals. Also free parking which is clutch because campus parking is already a nightmare.", name: "Bella S.", date: "2026-02-20" },
  { studioId: "goleta", teacher: "Kaitlyn V.", classType: "ys", rating: 4, teacherRating: 5, cleanRating: 4, vibeRating: 4, diffRating: 4, heatRating: 4, text: "Kaitlyn's Sculpt class is literally the hardest workout I've ever done and I played D3 soccer. The playlist goes so hard and she hypes you up the whole time. Only thing is it gets super packed after 5pm — like get there 15 min early or you won't get a spot. Def worth the student discount if you can get one.", name: "Maddie K.", date: "2026-02-15" },
  { studioId: "goleta", teacher: "General Studio Review", classType: "c1", rating: 4, teacherRating: 4, cleanRating: 5, vibeRating: 4, diffRating: 4, heatRating: 2, text: "Came here with my sorority sisters and honestly had the best time. C1 is perfect if you've never done yoga before — super chill and not intimidating at all. The staff is really nice and the studio is way cleaner than I expected. It's right by Trader Joe's so we always grab snacks after lol.", name: "Ava J.", date: "2026-01-28" },
  ...
  { studioId: "goleta", teacher: "Sabrina Z.", classType: "ys", rating: 2, teacherRating: 2, cleanRating: 3, vibeRating: 2, diffRating: 3, heatRating: 4, text: "Ngl this was kind of a waste of money. The instructor barely explained anything and I had no idea what was going on half the time. My friend and I were just looking at each other like ??? Also it lowkey smelled in there. Idk maybe we just had an off day but I'm not rushing back.", name: "Zoe C.", date: "2026-01-03" },
  { studioId: "goleta", teacher: "General Studio Review", classType: "c2", rating: 2, teacherRating: 3, cleanRating: 2, vibeRating: 3, diffRating: 4, heatRating: 5, text: "OK so I almost passed out in the C2 class lmao. I know it's supposed to be hot but this was genuinely scary — like I couldn't breathe. Had to leave halfway through. The rental mats are also gross and super slippery. My friend who goes to the SB location said it's way better there. Might give that one a try instead.", name: "Jordan P.", date: "2025-12-18" },
  ...
  { studioId: "la-cumbre", teacher: "Jen M.", classType: "c2", rating: 3, teacherRating: 3, cleanRating: 3, vibeRating: 3, diffRating: 3, heatRating: 4, text: "Honestly not a great experience. The teacher talked way too much during the flow — felt more like a lecture than a yoga class. Couldn't get into any kind of rhythm. The plaza parking situation is also really annoying, especially on weekends. I'll stick to State Street.", name: "Katie R.", date: "2026-01-15" },
  { studioId: "la-cumbre", teacher: "General Studio Review", classType: "hpf", rating: 4, teacherRating: 4, cleanRating: 3, vibeRating: 4, diffRating: 3, heatRating: 5, text: "The HPF class itself was really solid — great heat, good flow, and the instructor kept good energy. My only gripe is the locker room could use some attention. Showers were a little grimy and someone left their stuff on the bench the whole class. The actual yoga experience is why I keep coming back though.", name: "Greg W.", date: "2025-12-28" },
  ...
  { studioId: "state-street", teacher: "General Studio Review", classType: "hpf", rating: 4, teacherRating: 4, cleanRating: 3, vibeRating: 4, diffRating: 3, heatRating: 5, text: "The HPF class was really solid — great heat, good flow, and the instructor brought good energy. Only knock is parking in downtown SB is a nightmare. I've been late to class twice because of it. Showers are also a bit small. Would be a 5-star studio if it weren't for the logistics of getting there.", name: "Jordan M.", date: "2026-01-08" },
  { studioId: "state-street", teacher: "Dani N.", classType: "ys", rating: 3, teacherRating: 3, cleanRating: 3, vibeRating: 3, diffRating: 4, heatRating: 4, text: "Yoga Sculpt was way more intense than I expected for an 'all levels' class. The instructor moved pretty fast through the weight transitions and I struggled to keep up as a first-timer. Would've appreciated more modifications being offered. That said, I can see how regulars would love it — just maybe not the best intro class.", name: "Amy L.", date: "2025-12-22" },
  { studioId: "state-street", teacher: "Riley M.", classType: "c2", rating: 4, teacherRating: 4, cleanRating: 3, vibeRating: 4, diffRating: 3, heatRating: 4, text: "Riley's C2 class was a good flow — she's got a nice teaching style and keeps things moving. My only complaint is the classes get really packed, especially the evening slots. My mat was touching both neighbors which isn't great in a heated room. Would be a 5 if they capped the class size a bit. Still one of the better studios in SB.", name: "Marcus T.", date: "2026-01-18" },
  ...
  { studioId: "thousand-oaks", teacher: "Jeanette D.", classType: "hpf", rating: 2, teacherRating: 2, cleanRating: 3, vibeRating: 2, diffRating: 3, heatRating: 5, text: "The room was so hot I genuinely felt sick. I've done hot yoga before but this was next level — like they cranked it up to punish us. The instructor didn't check in on anyone and seemed annoyed when I stepped out to get water. I get that it's supposed to be challenging but there's a line between hard and unsafe.", name: "Natalie P.", date: "2026-01-12" },
  { studioId: "thousand-oaks", teacher: "General Studio Review", classType: "ys", rating: 3, teacherRating: 3, cleanRating: 3, vibeRating: 2, diffRating: 4, heatRating: 3, text: "Tried Sculpt for the first time and it's just not for me. Felt more like a gym workout with some yoga poses thrown in. The music was blasting so loud I couldn't hear the cues. Also the regulars seem very cliquey — no one said hi or made eye contact. Not the warm community vibe I was hoping for.", name: "Sofia H.", date: "2025-12-30" },
  ...
  { studioId: "ventura", teacher: "Cody B.", classType: "c2", rating: 2, teacherRating: 2, cleanRating: 3, vibeRating: 3, diffRating: 2, heatRating: 3, text: "Really underwhelming C2 class. The sequence was super basic and repetitive — felt like we did the same three poses for 45 minutes. The instructor didn't demonstrate anything, just called out poses from the front of the room. I've been to 50+ CorePower classes at other locations and this was by far the weakest.", name: "Ryan K.", date: "2026-01-08" },
  { studioId: "ventura", teacher: "General Studio Review", classType: "ys", rating: 3, teacherRating: 3, cleanRating: 2, vibeRating: 3, diffRating: 4, heatRating: 4, text: "The Sculpt class was a solid workout but the studio itself needs some TLC. The floors were sticky, one of the mirrors had a crack, and the sound system was cutting in and out during class. It's a newer location so maybe they're still working things out, but it took away from the experience.", name: "Hannah B.", date: "2025-12-15" },
  ...
  { studioId: "westlake-village", teacher: "Kim B.", classType: "hpf", rating: 2, teacherRating: 3, cleanRating: 3, vibeRating: 2, diffRating: 3, heatRating: 5, text: "Drove 20 minutes to try this location and was pretty let down. The HPF room was absolutely sweltering — like dangerously hot. Two people left mid-class looking dizzy. The instructor acknowledged it was 'extra spicy today' but didn't adjust anything. I get that it's hot yoga but studios have a responsibility to keep it safe.", name: "Courtney A.", date: "2026-01-20" },
  { studioId: "westlake-village", teacher: "General Studio Review", classType: "c2", rating: 3, teacherRating: 3, cleanRating: 4, vibeRating: 2, diffRating: 3, heatRating: 3, text: "Nice enough studio but the vibe is kind of pretentious. Everyone's in matching Lululemon and the front desk staff gave me a look when I showed up in regular gym clothes. The class itself was fine — standard C2 flow. But the membership price combined with the attitude makes it hard to justify when there are other options nearby.", name: "Jason M.", date: "2025-12-10" }
];
